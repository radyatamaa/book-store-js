...
const LoginPage: React.FC<Props> = ({ customers: initialCustomers }) => {
  ...
  const handleNewCustomer = async () => {
    ...
    try {   
      ...
      const res = await axios.post<CustomerDetailResponse>(`${process.env.BASE_URL_API}/v1/customer`, {
...
export async function getStaticProps() {
  const res = await axios.get<CustomerResponse>(`${process.env.BASE_URL_API}/v1/customer`, {});
